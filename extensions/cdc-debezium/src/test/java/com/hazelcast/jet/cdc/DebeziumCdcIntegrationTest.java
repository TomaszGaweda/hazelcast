...
public class DebeziumCdcIntegrationTest extends AbstractCdcIntegrationTest {
    ...
    private static final DockerImageName MYSQL_IMAGE =
            DockerImageName.parse("debezium/example-mysql:1.9.1.Final").asCompatibleSubstituteFor("mysql");

    private static final DockerImageName POSTGRES_IMAGE =
            DockerImageName.parse("debezium/example-postgres:1.9.1.Final").asCompatibleSubstituteFor("postgres");
